function fill(){
    ...
    for(let i = 0; i < 20; i++){
        ...
        row.cells[1].innerHTML = '<img src="images/'+data["teams"][i]["name"].toLowerCase()+'/'+data["teams"][i]["name"].toLowerCase()+'.png">';
        row.cells[2].innerHTML = '<a href="teams/'+data["teams"][i]["name"].toLowerCase()+'.html">'+ data["teams"][i]["name"].replace("_", " ") + "</a>";  
